...
export default function ToggleInput({label,name,trueTitle,falseTitle,register,isActive}) {
  ...
  return (
    ...
    <h2 className="text-gray-900 dark:text-gray-300">{label}</h2>
</div>
<div className="w-full">
  ...
  <span className="ms-3 text-sm font-medium text-gray-900 dark:text-gray-300"> {isActive? `${trueTitle}`: `${falseTitle}`}  </span>
