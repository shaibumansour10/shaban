...
export default function TrainingCarousel({trainings}) {
  ...
  >
    ...
    <Image src={training.imageUrl} width={556} height={556} alt={training.title} className='w-full h-48 object-cover rounded-lg'/>
              </Link>
    <h2 className='text-center tdark:text-whitetext-black bg-slate-600 dark:bg-black rounded-md text-2xl'>
      ...
      <p className='text-black'>no community available</p>
     )
    }
  </Carousel>
  )
